...
import {exploreOutline, homeFill, homeOutline, messageFill, messageOutline, postUploadOutline,} from "./SvgIcons";
    ...
    return (
        <nav className="fixed top-0 w-full border-b bg-white z-10">
            ...
            <div
                ...
                {/* <!-- icons container  --> */}
                <div className="flex items-center space-x-6 ml-5 sm:mr-5">
                    <Link to="/">
                    ...
                    <div className="cursor-pointer sm:block">{exploreOutline}</div>
                    <Notifications/>

                    <div
                        onClick={() => setProfileToggle(!profileToggle)}
                        className={`${(profileToggle && "border-black border") || (!onHome && !onChat && "border-black border")} rounded-full cursor-pointer h-7 w-7 p-[0.5px]`}
                    >
                        <img
                            draggable="false"
                            loading="lazy"
